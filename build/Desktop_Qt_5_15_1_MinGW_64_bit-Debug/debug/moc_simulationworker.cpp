...
#include <memory>
#include "../../../src/core/simulationworker.h"
...
QT_MOC_LITERAL(1, 17, 13), // "dataGenerated"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 8), // "deviceId"
QT_MOC_LITERAL(4, 41, 8), // "newValue"
QT_MOC_LITERAL(5, 50, 13), // "statusMessage"
QT_MOC_LITERAL(6, 64, 7) // "message"

    },
    "SimulationWorker\0dataGenerated\0\0"
    "deviceId\0newValue\0statusMessage\0message"
};
...
void SimulationWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->dataGenerated((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< double(*)>(_a[2]))); break;
        ...
        {
            using _t = void (SimulationWorker::*)(int , double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SimulationWorker::dataGenerated)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (SimulationWorker::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SimulationWorker::statusMessage)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void SimulationWorker::dataGenerated(int _t1, double _t2)
{
...
// SIGNAL 1
void SimulationWorker::statusMessage(const QString & _t1)
{
