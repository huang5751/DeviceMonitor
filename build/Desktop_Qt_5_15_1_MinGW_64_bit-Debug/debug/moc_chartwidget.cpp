...
QT_MOC_LITERAL(1, 12, 12), // "chartCleared"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 14), // "dataPointAdded"
QT_MOC_LITERAL(4, 41, 8), // "deviceId"
QT_MOC_LITERAL(5, 50, 5), // "value"
QT_MOC_LITERAL(6, 56, 16), // "onDeviceSelected"
QT_MOC_LITERAL(7, 73, 11) // "updateChart"

    },
    "ChartWidget\0chartCleared\0\0dataPointAdded\0"
    "deviceId\0value\0onDeviceSelected\0"
    "updateChart"
};
...
void ChartWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->dataPointAdded((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< double(*)>(_a[2]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ChartWidget::chartCleared)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ChartWidget::*)(int , double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ChartWidget::dataPointAdded)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void ChartWidget::chartCleared()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void ChartWidget::dataPointAdded(int _t1, double _t2)
{
